...
numpoints = 20
# random.seed(42)
points = [L*random.rand(2) for i in range(numpoints)]
...
print('We found the MST for %d points in %.3f seconds.' % (numpoints, t2-t1))
...
print('The critical bond length is %f.' % (criticalbond))

graph_MST(newMST,points,L)
